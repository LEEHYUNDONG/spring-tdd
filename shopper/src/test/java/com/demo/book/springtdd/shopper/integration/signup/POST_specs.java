...
public class POST_specs {
    ...
    @ParameterizedTest
    @MethodSource("com.demo.book.springtdd.testutils.TestDatasource#invalidPasswords")
    void password_속성이_올바르게_지정되지_않으면_400_Bad_Request_상태를_반환한다(String invalidPassword, @Autowired TestRestTemplate client) {
        // arrange
